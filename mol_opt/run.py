...
from main.chemlactica.run import api_evaluated_oracle_names, APIOracle

# oracle list

""" 
['drd2', 'gsk3b', 'jnk3', 'fpscores', 'cyp3a4_veith', 'drd2_current',
'gsk3b_current', 'jnk3_current', 'qed', 'logp', 'sa', 'rediscovery', 
'similarity', 'median', 'isomers', 'mpo', 'hop', 'celecoxib_rediscovery', 
'troglitazone_rediscovery', 'thiothixene_rediscovery', 'aripiprazole_similarity', 
'albuterol_similarity', 'mestranol_similarity', 'isomers_c7h8n2o2', 'isomers_c9h10n2o2pf2cl', 
'isomers_c11h24', 'osimertinib_mpo', 'fexofenadine_mpo', 'ranolazine_mpo', 'perindopril_mpo', 
'amlodipine_mpo', 'sitagliptin_mpo', 'zaleplon_mpo', 'sitagliptin_mpo_prev', 'zaleplon_mpo_prev', 
'median1', 'median2', 'valsartan_smarts', 'deco_hop', 'scaffold_hop', 'novelty', 
'diversity', 'uniqueness', 'validity', 'fcd_distance', 'kl_divergence', 'askcos', 
'ibm_rxn', 'isomer_meta', 'rediscovery_meta', 'similarity_meta', 'median_meta', 
'docking_score', 'molecule_one_synthesis', 'pyscreener', 'rmsd', 'kabsch_rmsd', 
'smina', '1iep_docking', '2rgp_docking', '3eml_docking', '3ny8_docking', '4rlu_docking', 
'4unn_docking', '5mo4_docking', '7l11_docking', 'drd3_docking', '3pbl_docking', 
'1iep_docking_normalize', '2rgp_docking_normalize', '3eml_docking_normalize', 
'3ny8_docking_normalize', '4rlu_docking_normalize', '4unn_docking_normalize', 
'5mo4_docking_normalize', '7l11_docking_normalize', 'drd3_docking_normalize', 
'3pbl_docking_normalize', '1iep_docking_vina', '2rgp_docking_vina', '3eml_docking_vina', 
'3ny8_docking_vina', '4rlu_docking_vina', '4unn_docking_vina', '5mo4_docking_vina', 
'7l11_docking_vina', 'drd3_docking_vina', '3pbl_docking_vina']
"""
...
def main():
    ...
    elif args.method == "chemlactica":
        from main.chemlactica.run import ChemLactica_Optimizer as Optimizer
    else:
    ...
    if args.task != "tune":
        ...
        for oracle_name in args.oracles:
            ...
            if oracle_name in api_evaluated_oracle_names:
                oracle = APIOracle(name=oracle_name)
            else:
