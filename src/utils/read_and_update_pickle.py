...
with open("/home/menuab/code/ChemLacticaTestSuite/src/stats_data/pubchem_stats.pkl", 'rb') as pubchem_stats_file:
    pubchem_stats = pickle.load(pubchem_stats_file)
tanim = pd.read_csv("/home/menuab/code/ChemLacticaTestSuite/src/stats_data/tanimoto_sim.csv")
...
with open('/home/menuab/code/ChemLacticaTestSuite/src/stats_data/pubchem_stats_new.pkl', 'wb') as handle:
