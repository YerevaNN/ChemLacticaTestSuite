...
stale_egg_info = Path(__file__).parent / "contrastive_decodable_transformers.egg-info"
...
class DepsTableUpdateCommand(Command):
    ...
    user_options = [
        ...
        ("dep-table-update", None, "updates src/contrastive_decodable_transformers/dependency_versions_table.py"),
    ]
    ...
    def run(self):
        ...
        target = "src/contrastive_decodable_transformers/dependency_versions_table.py"
...
setup(
    name="contrastive_decodable_transformers",
