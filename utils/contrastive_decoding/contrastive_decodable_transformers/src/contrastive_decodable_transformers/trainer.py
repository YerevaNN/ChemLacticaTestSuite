...
class Trainer:
    ...
    def _hp_search_setup(self, trial: Union["optuna.Trial", Dict[str, Any]]):
        ...
        if self.args.deepspeed:
            ...
            from contrastive_decodable_transformers.deepspeed import HfTrainerDeepSpeedConfig
    ...
    def evaluation_loop(
        ...
        **kwargs,
        ...
        for step, inputs in enumerate(dataloader):
            ...
            # Prediction step
            loss, logits, labels = self.prediction_step(model, inputs, prediction_loss_only, ignore_keys=ignore_keys, **kwargs,)
