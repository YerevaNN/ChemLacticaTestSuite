...
from utils import LeadOptimizationQEDOracle
...
def parse_arguments():
    ...
    parser.add_argument("--qed_csv_path", type=str, required=True)
...
if __name__ == "__main__":
    ...
    molecules_df = pd.read_csv(args.qed_csv_path)
    ...
    for seed in seeds[:args.n_runs]:
        ...
        for i in tqdm(range(len(lead_molecules))):
            ...
            oracle = LeadOptimizationQEDOracle(lead_mol, max_oracle_calls=10000)
